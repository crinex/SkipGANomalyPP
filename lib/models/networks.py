...
from lib.models.subnetworks import build_subnetwork
...
def define_G(opt, norm='batch', use_dropout=False, init_type='normal'):
    ...
    netG = build_subnetwork() #UnetGenerator(opt.nc, opt.nc, num_layer, opt.ngf, norm_layer=norm_layer, use_dropout=use_dropout)
